...
We propose a latent-state-driven hazard model in which the hidden states of a Mamba-2 state-space model
represent demand regimes, and their energy defines a hazard rate governing stock survival.
...
It enables DOC-based probabilistic decision-making under regime uncertainty.
